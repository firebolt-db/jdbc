...
class SqlArrayUtilTest {
  ...
  void shouldTransformToEmptyArray() throws SQLException {
    ...
    Array result = SqlArrayUtil.transformToSqlArrayFunction.apply(value, FireboltColumn.of("Array(INT32)"));
  ...
  void shouldTransformStringArray() throws SQLException {
    ...
    Array result = SqlArrayUtil.transformToSqlArrayFunction.apply(value, FireboltColumn.of("Array(TEXT)"));
  ...
  void shouldTransformArrayOfTuples() throws SQLException {
    ...
    Array result = SqlArrayUtil.transformToSqlArrayFunction.apply(value, FireboltColumn.of("Array(TUPLE(int,string))"));
  ...
  void shouldTransformArrayOfArrayTuples() throws SQLException {
    ...
    Array result = SqlArrayUtil.transformToSqlArrayFunction.apply(value, FireboltColumn.of("Array(Array(TUPLE(int,string)))"));
