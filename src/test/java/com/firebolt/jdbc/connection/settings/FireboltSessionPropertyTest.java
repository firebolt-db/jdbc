...
class FireboltSessionPropertyTest {
    ...
    void shouldNotReturnAnyDeprecatedProperty() {
        ...
        List<FireboltSessionProperty> deprecatedProperties = Arrays.asList(TIME_TO_LIVE_MILLIS, MAX_CONNECTIONS_PER_ROUTE, USE_PATH_AS_DB,
                USE_PATH_AS_DB, USE_CONNECTION_POOL, VALIDATE_AFTER_INACTIVITY_MILLIS);
