...
public class TLSTest extends IntegrationTest {
    ...
    public void shouldUseTLS() throws SQLException, IOException, NoSuchFieldException, IllegalAccessException {
        ...
        /* The code below generates TLS certificates for the mock server
        based on https://github.com/square/okhttp/blob/052a73d3abe536c0f04b5c7b04d35123cc2500a8/okhttp-tls/README.md */
        ...
        //Write the public certificate to a file that will be used by the driver for the TLS handshake
        ...
        try (FireboltConnection fireboltConnection = (FireboltConnection) createLocalConnection(String.format("?ssl_certificate_path=%s&port=%s", path, mockBackEnd.getPort())); Statement statement = fireboltConnection.createStatement()) {
