...
@Slf4j
public class FireboltJSONResultSet extends AbstractResultSet {
...
//  JSONObject json = new JSONObject(tokener);
  ...
  public FireboltJSONResultSet(InputStream is) throws SQLException {
    this(is, null, null, null, false, null, false);
  }

  public FireboltJSONResultSet(InputStream is, String tableName, String dbName, Integer bufferSize)
      throws SQLException {
    this(is, tableName, dbName, bufferSize, false, null, false);
  }

  public FireboltJSONResultSet(
      InputStream is,
      String tableName,
      String dbName,
      Integer bufferSize,
  ...
  public static FireboltJSONResultSet empty() {
    return new FireboltJSONResultSet();
  }
