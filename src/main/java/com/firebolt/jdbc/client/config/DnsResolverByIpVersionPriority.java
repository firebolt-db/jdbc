...
public class DnsResolverByIpVersionPriority implements DnsResolver {
	...
	public InetAddress[] resolve(String host) throws UnknownHostException {
		...
		return Arrays.stream(ips).sorted((address1, address2) -> {
	 ...
	 * {@link SystemDefaultDnsResolver#resolveCanonicalHostname(String)} except that
	 * it picks the ip using IPV6 in priority.
	 */
	@Override
