...
public class JdkLogger implements FireboltLogger {
    ...
    /**
     * SLF4J and java.util.logging use a different log format. With SLF4J it is not required to have argument indexes in
     * the logs (eg: "log.info("hello {}", "world");), but it is required for java.util.logging (eg: "log.info("hello {1}", "world");)
     * In this project we use the SLF4J way of logging, which is why we need to add the missing indexes.
     */
