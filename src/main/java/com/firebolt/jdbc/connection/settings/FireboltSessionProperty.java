...
public enum FireboltSessionProperty {
    ...
    TIME_TO_LIVE_MILLIS("time_to_live_millis", 60 * 1000, Integer.class,
            ...
            "timeToLiveMillis"),
    @Deprecated
    MAX_CONNECTIONS_PER_ROUTE("max_connections_per_route", 500, Integer.class,
    ...
    @Deprecated
    USE_CONNECTION_POOL(
            "use_connection_pool", true, Boolean.class,
    ...
    FireboltSessionProperty(String key, Object defaultValue, Class<?> clazz, String description,
                            String... aliases) {
        this.key = key;
