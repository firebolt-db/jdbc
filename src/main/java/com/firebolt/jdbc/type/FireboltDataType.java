...
public enum FireboltDataType {
	...
	U_INT_8(Types.TINYINT, FireboltDataTypeDisplayNames.INTEGER, BaseType.INTEGER, false, false, 3, 0, 0, false, "UInt8"),
	BOOLEAN(Types.BOOLEAN, FireboltDataTypeDisplayNames.BOOLEAN, BaseType.BOOLEAN, false, false, 1, 0, 0, false, "Boolean", "BOOL"),
	...
	// be handled for now
	BIG_INT_64(Types.BIGINT, FireboltDataTypeDisplayNames.BIGINT, BaseType.BIGINT, false, false, 0, 0, 0, false, "Int64", "UInt64"),
	// Although not supported, U_INT_64 is still coming from Firebolt and needs to
	// be handled for now
	UNISGNED_BIG_INT_64(Types.BIGINT, FireboltDataTypeDisplayNames.BIGINT, BaseType.BIGINT, false, false, 0, 0, 0, false, "UInt64"),
	...
	TEXT(Types.VARCHAR, FireboltDataTypeDisplayNames.TEXT, BaseType.TEXT, false, true, 0, 0, 0, false, "String", "VARCHAR",
			"TEXT"),
	DATE(Types.DATE, FireboltDataTypeDisplayNames.DATE, BaseType.DATE, false, false, 10, 0, 0, true, "Date", "PGDate"),
	...
	DATE_TIME(Types.TIMESTAMP,  FireboltDataTypeDisplayNames.TIMESTAMP, BaseType.TIMESTAMP, false, false, 19, 0, 6, true, "DateTime", "TIMESTAMP"),
	TIMESTAMP(Types.TIMESTAMP, FireboltDataTypeDisplayNames.TIMESTAMP, BaseType.TIMESTAMP, false, false, 26, 0, 6, true, "TimestampNtz"),
	TIMESTAMP_WITH_TIMEZONE(Types.TIMESTAMP_WITH_TIMEZONE, FireboltDataTypeDisplayNames.TIMESTAMP_WITH_TIMEZONE, BaseType.TIMESTAMP_WITH_TIMEZONE, false, false, 32, 0, 6, true, "Timestamptz"),
