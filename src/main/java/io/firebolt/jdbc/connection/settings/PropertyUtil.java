...
public class PropertyUtil {
    ...
    public static FireboltProperties extractFireboltProperties(String uri, Properties connectionSettings, Function<Properties, FireboltProperties> propertiesTransformer) {
    ...
    private static Properties mergeProperties(Properties connectionSettings, Properties uriProperties) {
