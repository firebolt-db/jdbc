...
public enum FireboltSessionProperty {
  BUFFER_SIZE(
      ...
      65536,
      Integer.class,
      "The buffer for the response in bytes (Buffer size of the ResultSet returned by the driver)"),
  APACHE_BUFFER_SIZE(
      "apache_buffer_size",
      65536,
      Integer.class,
  ...
  USE_PATH_AS_DB(
      ...
      true,
      Boolean.class,
      "Enable/disable the usage of the URL path as the database."),
  PATH("path", "/", String.class, "URL path"),
  CHECK_FOR_REDIRECTS(
      "check_for_redirects",
      false,
      Boolean.class,
      "Whether 307 redirects should be checked using GET before sending POST to given URL"),
  MAX_REDIRECTS(
      "max_redirects", 5, Integer.class, "Maximum of redirects before using the last URL"),
  MAX_RETRIES("max_retries", 3, Integer.class, "Maximum number of retries. Set to 0 to disable"),
  ...
  TIME_TO_LIVE_MILLIS(
      ...
      60 * 1000,
      Integer.class,
      "Maximum life span of connections regardless of their keepAliveTimeout"),
  DEFAULT_MAX_PER_ROUTE(
      "defaultMaxPerRoute", 500, Integer.class, "Maximum total connections per route"),
  ...
  USE_OBJECTS_IN_ARRAYS(
      ...
      false,
      Boolean.class,
      "Whether arrays of objects (Object[]) should be used instead of primitive arrays. False by default"),
  USE_CONNECTION_POOL(
