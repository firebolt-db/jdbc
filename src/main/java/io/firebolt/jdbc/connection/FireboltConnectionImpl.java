...
public class FireboltConnectionImpl implements Connection {
    ...
    public FireboltConnectionImpl(String url, Properties connectionSettings, FireboltAuthenticationService fireboltAuthenticationService, FireboltEngineService fireboltEngineService) {
    ...
    public FireboltConnectionImpl(String url, Properties connectionSettings) {
        ...
        this.fireboltProperties = PropertyUtil.extractFireboltProperties(url, connectionSettings, new PropertiesToFireboltPropertiesTransformer());
        CloseableHttpClient httpClient = getHttpClient(fireboltProperties);
        fireboltAuthenticationService = new FireboltAuthenticationService(new FireboltAuthenticationClient(httpClient, objectMapper));
        fireboltEngineService = new FireboltEngineService(new FireboltAccountClient(httpClient, objectMapper));
    ...
    private void initConnection(String url, Properties connectionSettings, FireboltProperties fireboltProperties) {
        fireboltProperties = fireboltProperties == null ? PropertyUtil.extractFireboltProperties(url, connectionSettings, new PropertiesToFireboltPropertiesTransformer()) : fireboltProperties;
        log.info("Connecting to {}", url);
        try {
            FireboltConnectionTokens tokens = fireboltAuthenticationService.getConnectionTokens(fireboltProperties.getHost(), fireboltProperties.getUser(), fireboltProperties.getPassword());
            String engineAddress = fireboltEngineService.getEngineAddress(fireboltProperties.getHost(), fireboltProperties.getDatabase(), fireboltProperties.getEngine(), fireboltProperties.getAccount(), tokens.getAccessToken());
